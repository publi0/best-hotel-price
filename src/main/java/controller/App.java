...
import controller.business.CalculateHotelPrice;
import controller.business.ImportFileAndRetornClient;
...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        hotels.add(new Hotel(3, "Lakewoood", 110.00, 90.00, 80.00, 80.00));
